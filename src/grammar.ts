...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "if", "symbols": [{"literal":"if"}, "__", "boolean", "_", "code", {"literal":"end"}], "postprocess": ([,,expr,,code]) => ({ _: 'if', expr, code })},
    {"name": "if", "symbols": [{"literal":"if"}, "__", "boolean", "_", "code", "_", {"literal":"else"}, "_", "code", {"literal":"end"}], "postprocess": ([,,expr,,code,,,,code2]) => ({ _: 'if', expr, code, code2 })},
    ...
    {"name": "boolean", "symbols": ["expr"], "postprocess": id},
    {"name": "boolean", "symbols": ["boolean", "_", "boolop", "_", "expr"], "postprocess": ([left,,op,,right]) => ({ _: 'binary', left, op, right })},
