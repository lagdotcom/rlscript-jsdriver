...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "decl", "symbols": ["enumdecl"], "postprocess": id},
    ...
    {"name": "fndecl", "symbols": [{"literal":"fn"}, "__", "name", "_", "paramlist", "maybentype", "_", "code", {"literal":"end"}], "postprocess": ([,,name,,params,type,,code]) => ({ _: 'fn', name: name.value, params, type, code })},
    ...
    {"name": "globaldecl", "symbols": ["globalcw", "__", "field"], "postprocess": ([tok,,field]) => ({ _: tok.value, name: field.name, type: field.type })},
    {"name": "globaldecl", "symbols": ["globalcw", "__", "field", "_", {"literal":"="}, "_", "expr"], "postprocess": ([tok,,field,,,,expr]) => ({ _: tok.value, name: field.name, type: field.type, expr })},
    ...
    {"name": "globalcw", "symbols": [{"literal":"global"}], "postprocess": id},
    {"name": "globalcw", "symbols": [{"literal":"persistent"}], "postprocess": id},
    ...
    {"name": "enumvals", "symbols": ["enumval"]},
    {"name": "enumvals", "symbols": ["enumvals", "__", "enumval"], "postprocess": ([values,,value]) => values.concat(value)},
    {"name": "enumval", "symbols": ["name"], "postprocess": ([name]) => ({ name })},
    {"name": "enumval", "symbols": ["name", "_", {"literal":"="}, "_", "expr"], "postprocess": ([name,,,expr]) => ({ name, expr })},
    {"name": "maybentype", "symbols": [], "postprocess": () => undefined},
    {"name": "maybentype", "symbols": [{"literal":":"}, "_", "ntype"], "postprocess": ([,,type]) => type},
    ...
    {"name": "assignop", "symbols": [{"literal":"/="}], "postprocess": val},
    {"name": "assignop", "symbols": [{"literal":"^="}], "postprocess": val},
    {"name": "local", "symbols": ["localcw", "__", "field"], "postprocess": ([,,field]) => ({ _: 'local', name: field.name, type: field.type })},
    {"name": "local", "symbols": ["localcw", "__", "field", "_", {"literal":"="}, "_", "expr"], "postprocess": ([,,field,,,,expr]) => ({ _: 'local', name: field.name, type: field.type, expr })},
    {"name": "localcw", "symbols": [{"literal":"local"}], "postprocess": id},
    {"name": "localcw", "symbols": [{"literal":"let"}], "postprocess": id},
    ...
    {"name": "match", "symbols": [{"literal":"else"}, "_", {"literal":"="}, "_", "expr"], "postprocess": ([,,,,value]) => ({ _: 'else', value })},
    {"name": "match", "symbols": ["boolop", "_", "sum", "_", {"literal":"="}, "_", "expr"], "postprocess": ([op,,expr,,,,value]) => ({ _: 'binary', op: op.value, expr, value})},
