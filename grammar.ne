...
globaldecl -> globalcw __ field {% ([tok,,field]) => ({ _: tok.value, name: field.name, type: field.type }) %}
            | globalcw __ field _ "=" _ expr {% ([tok,,field,,,,expr]) => ({ _: tok.value, name: field.name, type: field.type, expr }) %}
